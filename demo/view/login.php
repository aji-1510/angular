  ...
  .container .profile .img{
    ...
    <body>
       ...
       <form action="" method="post" enctype="multipart/form-data">
            ...
            <?php
            if(isset($login_msg)){
                echo '<div class"message">'.$login_msg.'</div>';
                 }?>  
            ...
            <input type="cancel" name="cancel" value="Cancel" class="btn">
            <p>Dont have a account ? <a href="http://localhost/project/demo/index.php?model=user&view=register">Register now</a> </p>
            </form>
       </div> 
