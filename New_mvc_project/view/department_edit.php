...
<form action="http://localhost/mywebsite/new_mvc_project/index.php?model=department&view=departmentupdate" method="post" enctype="multipart/form-data">
    <br>
        <table align="center"> 
            <?php 
            ...
            <tr> 
                ...
                <td class="col-sm-8">
                    <div class="col-sm-10">
                      <input type="text" name="departmentName" class="form-control" value="<?php echo $row['DepartmentName'] ?>" placeholder="Enter Department Name">
                    </div>
                    </div>
                </td>
            <tr>
                <td> 
                    <input type="submit" value="Update" name="Update" class="btn btn-light mr-1">  
                 </td>
                 <td>
