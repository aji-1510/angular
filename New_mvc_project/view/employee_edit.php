...
<form action="http://localhost/mywebsite/new_mvc_project/index.php?model=employee&view=employee_edit_click" method="post" enctype="multipart/form-data">
    <br>
    <br>
 <div class="container">   
    ...
    <?php 
        ...
        <div class="form-froup row" style="width: 60%;">
            ...
            <label class="col-sm-2 col-form-label">Employee Name</label>
                <div class="col-sm-10">
                    <input type="text" name="emp_Id"  class="form-control" value="<?php echo $row['EmployeeId'] ?>" required  placeholder="Enter Employee Name">
                </div>

  
            <label class="col-sm-2 col-form-label">Employee Name</label>
                <div class="col-sm-10">
                    <input type="text" name="emp_name" class="form-control" value="<?php echo $row['EmployeeName'] ?>" required  placeholder="Enter Employee Name">
                </div>
                 ...
                 <div class="col-sm-10">
                        <select class="form-control" name="departmentName" >
                           ...
                           $conn=$obj->dbcon();
                            ...
                            echo "<option>"."--sele"."</option>";
                            while ($ro=$sql->fetch_assoc())
                            {
                                echo "<option>".$ro['DepartmentName']."</option>";
                            }
                            ?>
                        </select>
                    </div>
